...
export const CREATE_ENROLLMENT_RESPONSE = 'CREATE_ENROLLMENT_RESPONSE'
export const GET_ENROLLMENT = 'GET_ENROLLMENT'
export const GET_ENROLLMENTS = 'GET_ENROLLMENTS'
export const GET_ENROLLMENTS_RESPONSE = 'GET_ENROLLMENTS_RESPONSE'
export const UPDATE_ENROLLMENT = 'UPDATE_ENROLLMENT'
export const UPDATE_ENROLLMENT_RESPONSE = 'UPDATE_ENROLLMENT_RESPONSE'
export const DELETE_ENROLLMENT = 'DELETE_ENROLLMENT'
export const DELETE_ENROLLMENT_RESPONSE = 'DELETE_ENROLLMENT_RESPONSE'

export const CREATE_REPRESENTATIVE = 'CREATE_REPRESENTATIVE'
export const CREATE_REPRESENTATIVE_RESPONSE = 'CREATE_REPRESENTATIVE_RESPONSE'
export const GET_REPRESENTATIVE = 'GET_REPRESENTATIVE'
export const GET_REPRESENTATIVES = 'GET_REPRESENTATIVES'
export const GET_REPRESENTATIVES_RESPONSE = 'GET_REPRESENTATIVES_RESPONSE'
export const UPDATE_REPRESENTATIVE = 'UPDATE_REPRESENTATIVE'
export const UPDATE_REPRESENTATIVE_RESPONSE = 'UPDATE_REPRESENTATIVE_RESPONSE'
export const DELETE_REPRESENTATIVE = 'DELETE_REPRESENTATIVE'
export const DELETE_REPRESENTATIVE_RESPONSE = 'DELETE_REPRESENTATIVE_RESPONSE'
